...
const Cover = (theme) => {
  ...
  const material = new THREE.ShaderMaterial({
    ...
    uniforms: {
      uPointSize: { value: 2 },
      uTexture: { value: new THREE.TextureLoader().load("cover2.png") },
      uNLines: { value: nRows },
...
void main() {
  ...
  transformed.z += sin(transformed.x *0.08 + uTime*0.015) * 1.;
  transformed.z += sin(transformed.y *0.08 + uTime*0.015) * 1.;
